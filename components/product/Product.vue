...
export default {
    ...
    methods :{
        ...
        addToCart(){
            //actionsun içindeki addToCarta gönderdi
            this.$store.dispatch("addToCart",{count : this.product_count , ...this.product})//...this.product dediğimizde üç nokta içinde ne varsa al demek
        }
    }
}
</script>